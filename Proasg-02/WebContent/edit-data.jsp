...
<body>
	...
	<%  
		...
		User d=Edit_Dao.getRecordById(Integer.parseInt(id));  
	%>
	...
	<form action="./editdata" method="post">
		<div class="container">	
			...
			<input type="text" id="username" name="username" placeholder="<%=d.getUsername() %>">
			<br>
			<label for="contactno">Contact Number</label>
			<input type="text" id="contactno" name="contactno" placeholder="<%=d.getContactno() %>">
			<br>
